...
```{r, eval = FALSE}
x <- carbon$new(readLines("https://gist.githubusercontent.com/mcanouil/59bf911b3e780847d60524774b27fc58/raw/12bd198e14569aa83e46ea89c8597565404be67d/.Rprofile"))
x$template <- "cobalt"
...
# Utiliser un Mode "Projet" | `r include_graphics(here("images", "face-with-uneven-eyes-and-wavy-mouth_1f974.png"))`</br>(Voir "[Project-oriented workflow](https://rstats.wtf/project-oriented-workflow.html#dilemma-and-a-solution)")
